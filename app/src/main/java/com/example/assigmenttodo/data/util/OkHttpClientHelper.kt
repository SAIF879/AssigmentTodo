package com.example.assigmenttodo.data.util
import android.util.Log
import com.chuckerteam.chucker.api.ChuckerCollector
import com.chuckerteam.chucker.api.ChuckerInterceptor
import com.example.assigmenttodo.TodoApplication
...
class OkHttpClientHelper {
    ...
    fun getOkHttpClient(): OkHttpClient {
        val httpCacheDirectory = File(TodoApplication.instance?.cacheDir, "http-cache")
    ...
    private fun getChuckerInterceptor(): ChuckerInterceptor? {
        ...
        val context = TodoApplication.instance
        return context?.let {
